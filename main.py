# main.py (ETH up/down 15m, perfect 900 rows per session, uploads after session end)
...
# ETH
SLUG_URL = "https://polymarket.com/event/eth-updown-15m-1766516400"
...
def write_header(writer: csv.writer):
    ...
    headers.append("eth_chainlink_usd")
